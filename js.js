...
function initTabToggleListner() {
    let tabVideo = document.getElementsByClassName('tab_video')[0],
        tabEvents = document.getElementsByClassName('tab_events')[0],
...
function initPlayerControls() {
    var videoNodes = Array.from(document.getElementsByTagName('video')),
        backButton = document.getElementsByClassName('')[0];

    videoNodes.forEach(function(video) {
        let brigthness = video.parentNode.getElementsByClassName('input__brightness')[0],
            contrast = video.parentNode.getElementsByClassName('input__contrast')[0],
...
function audioEqulazer() {
    ...
    this.video.addEventListener('canplay', function () {
        ...
        an.source = an.context.createMediaElementSource(an.video);
